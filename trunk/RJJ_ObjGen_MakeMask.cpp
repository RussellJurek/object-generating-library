...
float AddIDsToChunk(float progress, int * temp_indices, int * flag_vals, object_props ** detections, int NOobj, int obj_limit, int chunk_x_start, int chunk_y_start, int chunk_z_start, int chunk_x_size, int chunk_y_size, int chunk_z_size, int * data_metric, int * xyz_order){
...
void CreateFitsMask(std::string output_code, int NOx, int NOy, int NOf, object_props ** detections, int NOobj, int obj_limit, int * flag_vals, int chunk_x_size, int chunk_y_size, int temp_chunk_x_size, int temp_chunk_y_size, int * data_metric, int * xyz_order){
