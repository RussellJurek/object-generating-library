...
float CreateMoment0Map(float * plot_array, int NOobj, object_props ** detections, int NOx, int NOy, int obj_limit, int obj_batch_limit){
...
float CreateRAPVPlot(float * plot_array, int NOobj, object_props ** detections, int NOx, int NOz, int obj_limit, int obj_batch_limit){
...
float CreateDecPVPlot(float * plot_array, int NOobj, object_props ** detections, int NOy, int NOz, int obj_limit, int obj_batch_limit){
...
int CreateMoment0Bounds(object_props ** detections, int size_x, int size_y, int min_x, int min_y, float * plot_x, float * plot_y, int obj, int obj_limit){
...
int CreateRAPVBounds(object_props ** detections, int size_x, int size_y, int size_z, int min_x, int min_z, float * plot_x, float * plot_y, int obj, int obj_limit){
...
int CreateDecPVBounds(object_props ** detections, int size_x, int size_y, int size_z, int min_y, int min_z, float * plot_x, float * plot_y, int obj, int obj_limit){
